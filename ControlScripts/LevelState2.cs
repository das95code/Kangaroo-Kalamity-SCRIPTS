...
public class LevelState2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isNivel2Completed) //Si el nivel esta completado...
        {
            spriteRenderer.sprite = spriteAzul; //...el sprite sera azul.
        }

        else if (isNivel1Completed) //Si el nivel anterior esta completado (pero este no)...
        {
