...
public class PlayerMoveOnIce : MonoBehaviour
{
    ...
    public bool juegoPausado = false; //Variable para controlar si el juego esta en pausa.
    ...
    void FixedUpdate() 
    {
        ...
        CheckForGround(); //Llamamos al metodo para identificar si estamos pisando el suelo.
            ...
            else //En cualquier caso contrario, el personaje resbalara por la plataforma.
            {
                // Aplicar una fuerza horizontal para simular el deslizamiento
                float fuerzaResbalar = 1.5f;
                rb2D.AddForce(new Vector2(rb2D.velocity.x * -fuerzaResbalar, 0));
            }
